...
import withAgenda from '../withAgenda';
...
describe('Agenda Controller', () => {
  ...
  it('Should render the wrapped component with props', () => {
    const WrappedComponent = withAgenda(Agenda);
    ...
    expect(myComponent.parent.props.currentItem).toEqual(null); // Update test when bug Fix is merged
